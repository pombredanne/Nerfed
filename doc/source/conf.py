# -*- coding: utf-8 -*-
#
# Nerfed documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Nerfed.tex', u'Nerfed Documentation',
...
man_pages = [
    ('index', 'nerfed', u'Nerfed Documentation',
...
texinfo_documents = [
  ('index', 'Nerfed', u'Nerfed Documentation',
   u'Amirouche Boubekki', 'Nerfed', 'One line description of project.',
   'Miscellaneous'),
]
